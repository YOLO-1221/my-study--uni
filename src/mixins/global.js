 ...
 * screenHeight 整屏高度
 */
let { statusBarHeight, safeAreaInsets, screenWidth, screenHeight, theme } =
  sysInfo;
// 底部安全距离
...
// 设计固定的自定义导航栏高度
let navBarHeight =
  menuButtonInfo.height + (menuButtonInfo.top - statusBarHeight) * 2 || 44;
...
export const TAB_PATHS = ["pages/style/index", "pages/comp/index"];
